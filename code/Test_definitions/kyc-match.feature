Feature: CAMARA Know Your Customer Match API, v0.4.0-rc.1 - Operation KYC_Match
    ...
    #
    # References to OAS spec schemas refer to schemas specifies in kyc-match.yaml, version v0.4.0-rc.1
